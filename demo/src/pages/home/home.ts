...
export class HomePage {
  public myPlaylist = [
      new Track('https://api.soundcloud.com/tracks/62188129/stream?client_id=df942240e3e63f8e23596df0893eab2a',
                ...
                'Mac Demarco', 
                'Passing Out Pieces', 
                'https://i1.sndcdn.com/artworks-000068528071-wgnmyr-t500x500.jpg'),
                new Track('https://api.soundcloud.com/tracks/200105384/stream?client_id=df942240e3e63f8e23596df0893eab2a',
                'Mac Demarco', 
                'The Way You\'d Love Her', 
                'https://i1.sndcdn.com/artworks-000112901381-bcrh0d-t500x500.jpg')
              ];
